...
const sobreSkill = [
                    ...
                    '<p>Discord</p> <br> <p>Discord é mais uma opção para quem busca conversar na Internet, seja por texto ou voz, com algumas ferramentas bem interessantes.</p> <br>',
                    '<p>Python</p> <br> <p>É uma linguagem de programação amplamente usada em aplicações da Web, desenvolvimento de software, ciência de dados e machine learning (ML).</p> <br>',
